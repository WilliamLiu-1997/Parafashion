...
var TOTAL_STACK = 1073741824*2;
if (Module['TOTAL_STACK']) assert(TOTAL_STACK === Module['TOTAL_STACK'], 'the stack size can no longer be determined at runtime')

var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 1073741824*2;
...
assert(INITIAL_MEMORY == 1073741824*2, 'Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically');
...
var wasmBinaryFile;
  wasmBinaryFile = 'DerivePatchLayout.wasm';
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 1073741824*2);
