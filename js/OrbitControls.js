...
THREE.OrbitControls = function (object, domElement) {
	...
	function handleMouseMoveRotate(event) {
		...
		rotateLeft(1.5 * (element.clientWidth / element.clientHeight) * Math.PI * rotateDelta.x / element.clientWidth * scope.rotateSpeed);

		// rotating up and down along whole screen attempts to go 360, but limited to 180
		rotateUp(1.5 * Math.PI * rotateDelta.y / element.clientHeight * scope.rotateSpeed);
